    ...
    <div class="w-full min-h-screen grid place-items-center">
        <div class="w-full h-full rounded-lg bg-white backdrop:bg-gray/50">
            <div class="flex flex-col w-full p-8">
                ...
                <pre>{{ $records }}</pre> --}}
                @php
                    $headers = ['Reg ID', 'Date', 'Cost', 'Items', 'Generated by', 'Location','Report'];
                    $rows =
                        $records
                            ->map(function ($record) {
                                ...
                                $generated_by = $record->supervisorReports->first()->supervisor->name;
                                $actions = '';
                                ...
                                return [$regId, $date, $cost, $items, $generated_by , $location,$actions];
                            })->toArray();
                @endphp
